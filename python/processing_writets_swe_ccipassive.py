...
output_dir = r"..\SWE_ts_csv\CCI-Passive_0-25"
...
tools.write_grid_shuffle_ts('CCI Passive', output_dir, dict_swe_gldas_points, filter_prod=True, anomaly=False)
tools.write_grid_shuffle_ts('CCI Passive', output_dir, dict_swe_gldas_points, filter_prod=True, anomaly=True)